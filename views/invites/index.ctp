<div class="invites index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $invite['Invite']['created']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $invite['Invite']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $invite['Invite']['id'])); ?>
