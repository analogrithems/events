...
<?php echo $this->Form->create('Reservation');?>
	<fieldset>
		...
		<div class="eventDetails">
			<span class="eventLocation"><strong><?php echo __('Where: ');?></strong> <?php echo $event['Location']['name'];?></span>
			...
			<?php
				if(isset($reservation_count) && (int)$reservation_count > 0){
					echo '<span class="eventGuestCount"><strong>'.__('Already Attending: ').'</strong>'.$reservation_count.'</span>';
				}
			?>
		</div>
		<div class="eventForm">
...
<?php echo $this->Form->end(array('label'=>__('R.S.V.P.'),'class'=>'blue_button', 'div'=>array('class'=>'button')));?>
</div>
